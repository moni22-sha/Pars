           ...
           <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <p className="text-lg text-slate-600 mb-6 font-medium">
                   At Pars industries works, we specialize in delivering advanced engineering and tooling solutions designed for efficiency, consistency, and long-term performance.
                </p>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
           ...
           <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
             Partner with Pars insdutries works for precision-driven manufacturing support tailored to your industrial requirements.
           </p>
           <Link 
             to="/contact" 
