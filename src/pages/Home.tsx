...
// Added proper Framer Motion types here to prevent index signature errors
    ...
    <div className="overflow-hidden relative bg-slate-50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <span className="text-brand-gold">Built for Performance.</span>
            </motion.h1>
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/products" 
                className="inline-flex items-center justify-center bg-brand-accent text-white px-10 py-4 rounded-full font-bold hover:brightness-110 hover:scale-105 active:scale-95 transition-all shadow-lg shadow-blue-500/20"
              >
                View Products
              </Link>
              <Link 
                to="/contact" 
                className="inline-flex items-center justify-center bg-brand-gold text-slate-900 px-10 py-4 rounded-full font-bold hover:brightness-110 hover:scale-105 active:scale-95 transition-all shadow-lg shadow-yellow-500/20"
              >
                Contact Us
              </Link>
            </motion.div>
      ...
      <section className="py-24 bg-[#373e48]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <WhyChooseCard icon={Clock} title="30+ Years Experience" text="Decades of technical expertise and proven industry knowledge." />
            <WhyChooseCard icon={Users} title="1000+ Clients" text="Trusted by a growing network of industrial clients globally." />
            <WhyChooseCard icon={Factory} title="Modern Facility" text="Fully equipped 4000+ sq. ft. production infrastructure." />
            <WhyChooseCard icon={Zap} title="Timely Delivery" text="Efficient production planning and project execution." />
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              className="space-y-8"
            >
              <h2 className="text-4xl leading-tight font-bold text-slate-900">Precision-Driven Manufacturing</h2>
            ...
            <div className="relative">
               ...
               <motion.div 
                 ...
                 className="absolute -bottom-6 -left-6 bg-brand-accent p-8 rounded-lg shadow-xl text-white max-w-xs md:block hidden"
               >
                  ...
                  >
                    {filteredProducts.map((product) => (
                      <motion.div
                        ...
                        className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all flex flex-col group border border-slate-200/60"
                      >
                        ...
                        <div className="p-8 flex flex-col flex-grow">
                          ...
                          <Link 
                            ...
                            className="inline-flex items-center justify-center bg-slate-900 text-white group-hover:bg-brand-accent font-bold text-sm py-3 px-6 rounded-xl transition-all text-center gap-2 mt-auto transform active:scale-95"
                          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex flex-col lg:flex-row gap-16 items-center">
             ...
             >
                ...
                <Link to="/about" className="text-brand-accent font-bold inline-flex items-center group mb-8 transition-colors hover:text-brand-accent/80">
             ...
             <div className="lg:w-1/2 order-1 lg:order-2 grid grid-cols-2 gap-4">
                ...
                <div className="space-y-4 pt-8">
                   <motion.div 
                     ...
                     className="h-48 bg-slate-100 rounded-lg overflow-hidden relative shadow-md group"
                   >
                     <motion.img whileHover={{ scale: 1.08 }} transition={{ duration: 0.4 }} src={image25} className="w-full h-full object-cover" alt="Detail 3" />
                   </motion.div>
                   <motion.div 
                     initial={{ opacity: 0, y: 30 }}
                     whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Comprehensive Engineering & Tooling Solutions</h2>
           ...
           <div className="mt-12 text-center">
              <Link to="/services" className="inline-flex items-center text-brand-accent hover:text-white font-bold transition-colors group">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <motion.div 
           ...
           className="absolute -right-20 -top-20 text-white/10 opacity-40 pointer-events-none"
        >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
           ...
           <Link 
             to="/contact" 
             className="inline-flex items-center justify-center bg-white text-brand-accent px-12 py-5 rounded-full font-bold text-lg hover:bg-slate-50 transition-all hover:scale-105 active:scale-95 shadow-xl"
           >
             Contact Us Today
           </Link>
        </div>
...
function WhyChooseCard({ icon: Icon, title, text }: { icon: React.ComponentType<IconProps>, title: string, text: string }) {
  return (
    <motion.div 
      variants={itemVariants}
      whileHover={{ y: -8, backgroundColor: "#1e293b", borderColor: "#3b82f6" }}
      className="p-8 bg-black/40 border border-slate-800 rounded-xl flex flex-col items-center text-center group transition-all duration-300 backdrop-blur-sm shadow-md"
    >
      <div className="mb-6 text-brand-accent group-hover:scale-110 transition-transform duration-300">
        <Icon className="h-10 w-10" />
      </div>
      <h3 className="text-lg font-bold mb-2 text-white tracking-wide">{title}</h3>
  ...
  return (
    <div className="flex gap-4">
      <motion.div 
        ...
        className="shrink-0 p-3 bg-white shadow-sm border border-slate-100 rounded-lg text-brand-accent h-fit"
      >
...
function ServicePreviewCard({ title, text, link }: { title: string, text: string, link: string }) {
  return (
    <motion.div variants={itemVariants}>
      <Link to={link} className="block h-full group p-8 bg-slate-800 border border-slate-700 rounded-xl hover:bg-slate-800/80 hover:border-brand-accent transition-all duration-300 shadow-md">
         <div className="flex justify-between items-start mb-6">
            <Settings className="h-10 w-10 text-brand-accent opacity-60 group-hover:opacity-100 group-hover:rotate-45 transition-all duration-300" />
            <ArrowRight className="h-5 w-5 text-slate-500 group-hover:text-brand-accent transition-colors" />
         </div>
