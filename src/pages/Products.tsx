...
const productsList: ProductItem[] = [
  { name: 'Balacing Die Block', description: 'High-precision machined mounting flange manufactured with advanced CNC machining for industrial and engineering applications.', image: Balancingdie },
  { name: 'Claw-blank', description: 'High-precision progressive die base manufactured using advanced CNC machining and tooling technology.', image: claw },
  { name: 'Ejector Pins', description: 'High-precision dowel pins engineered for progressive die applications and precision tooling systems.', image: ejectorpins },
  { name: 'Fine Blanking Dies', description: 'High-precision CNC machined plate component manufactured for industrial tooling.', image: fine },
  { name: 'Lower spring sheet', description: 'High-precision carbide die insert manufactured for progressive dies and press tool applications.', image: lower },
  { name: 'Punch Holder', description: 'High-precision machined die block manufactured using advanced CNC machining.', image: punch },
  { name: 'Sheet Metal', description: 'High-precision slotted die plate manufactured using advanced wire-cut EDM and CNC machining.', image: sheetmetal },
  { name: 'Slitting Die Insert', description: 'High-precision wire-cut EDM die block manufactured for progressive die configurations.', image: slitting },
  { name: 'Base Insert', description: 'High-precision progressive die assembly designed for complex sheet metal stamping.', image: base },
   {
...
export default function Products() {
  return (
    <div className="bg-slate-50 min-h-screen flex flex-col w-full">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
<h2 className="text-5xl md:text-6xl text-center text-lightblue font-black mb-6 tracking-tight">Fine Blanking Tool  
</h2>
<h3 className="text-5xl md:text-6xl text-center  font-yellow mb-6 tracking-tight">of Progressive</h3>
